    ...
    \subsection{Model I: LVLG(Lokta-Volterra and Leslie-Gower) Model}
      ...
      \begin{figure}[H]
        \centering
          \begin{minipage}[b]{0.45\linewidth}
              \centering
              \includegraphics[height=5.5cm, keepaspectratio]{images/LGVGField.pdf} % 替换为你的第一张图片路径
        ...
        \hspace{0.05\linewidth}
          \begin{minipage}[b]{0.45\linewidth}
              \centering
              \includegraphics[height=5.5cm, keepaspectratio]{images/SimpleFoodWeb.pdf} % 替换为你的第二张图片路径
      ...
      \subsection{Model II: }
        ...
        \subsubsection{Agricultural Cycle}
          According to rice production in Indonesia \cite{cite}, 
          ...
          Based on the literature review \cite{cite}, 
          the biomass fate of mature rice during each overlapping period can be uniformly described by the figure below \cite{cite}. 
          Since decomposers' biomass is not considered in our food web model, 
          we only analyze the impact of decomposed rice straw residue (1) on the producers—namely rice and weeds—in the new cycle. 
          ...
          and each week being a time step, based on the rice production pattern \cite{cite}, 
        ...
        \subsubsection{Seasonality}
          ...
          we refer to \cite{cite} and set sinusoidal perturbations in the periodic parameter $p(T)$ as follows:
